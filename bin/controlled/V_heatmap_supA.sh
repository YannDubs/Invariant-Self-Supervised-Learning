...
experiment=$prfx"V_heatmap_supA"
notes="
...
if [ "$is_plot_only" = false ] ; then
  for kwargs_dep in  "representor=std_cntr_supA encoder.z_shape=512" "representor=cntr,cntr_mlpXXS,cntr_mlp encoder.z_shape=2048"
  do
