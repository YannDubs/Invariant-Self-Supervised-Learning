...
kwargs_multi="
encoder.z_shape=2,4,16,64,256,1024,4096
seed=1
"
# TODO: run seed 2,3
...
if [ "$is_plot_only" = false ] ; then
  for kwargs_dep in   "representor=exact_250A architecture@predictor=linear" "representor=exact_250A_mlp architecture@predictor=mlp_h2048_l2" "representor=exact_250A_mlpXXS architecture@predictor=mlp_h32_l1"
  do
...
python utils/aggregate.py \
       ...
       +kwargs.pretty_renamer.Exact_250A_MlpXXS="calF" \
