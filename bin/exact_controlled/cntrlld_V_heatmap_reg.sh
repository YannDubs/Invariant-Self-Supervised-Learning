...
experiment=$prfx"cntrlld_V_heatmap_reg"
notes="
...
if [ "$is_plot_only" = false ] ; then
  for kwargs_dep in  "representor=exact_250A,exact_250A_mlpXXS,exact_250A_mlp"
  do
...
python utils/aggregate.py \
       ...
       +kwargs.pretty_renamer.Exact_250A_Mlpxxs="MLP --" \
       +kwargs.pretty_renamer.Exact_250A_Mlp="MLP ++" \
