...
experiment=$prfx"cntrlld_V_heatmap_supA_final"
notes="
...
if [ "$is_plot_only" = false ] ; then
  for kwargs_dep in  "representor=exact_mlpnano architecture@predictor=linear,mlp_h10_l1,mlp_h2048_l2" "representor=exact,exact_mlp architecture@predictor=mlp_h10_l1"
  do
    #"representor=exact,exact_mlpXXS,exact_mlp
...
python utils/aggregate.py \
       ...
       +kwargs.pretty_renamer.Exact_Mlpxxs="MLP --" \
