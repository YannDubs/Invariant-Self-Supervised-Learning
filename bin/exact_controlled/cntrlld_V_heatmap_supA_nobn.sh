...
experiment=$prfx"cntrlld_V_heatmap_supA_nobn"
notes="
...
data_pred.all_data=[data_repr_agg64]
predictor=pytorch
...
kwargs_multi="
architecture@predictor=linear,mlp_h32_l1_nobn,mlp_h2048_l2_nobn
regularizer=l2Mx
representor.loss.beta=1e-1
seed=1
representor=exact,exact_mlpXXS_nobn,exact_mlp_nobn
"
