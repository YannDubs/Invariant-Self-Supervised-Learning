...
if [ "$is_plot_only" = false ] ; then
  for kwargs_dep in  "regularizer=huber representor.loss.beta=1e-3 trainer.max_epochs=50,100,200" "regularizer=none representor.loss.beta=0 trainer.max_epochs=50,100"
  do
