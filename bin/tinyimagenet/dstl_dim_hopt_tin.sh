...
bttle_expand="encoder.rm_out_chan_aug=True,False +encoder.kwargs.arch_kwargs.bottleneck_mode=bttle_expand +encoder.kwargs.arch_kwargs.bottleneck_channel=512 "
