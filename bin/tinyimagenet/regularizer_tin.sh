...
if [ "$is_plot_only" = false ] ; then
  for kwargs_dep in  "regularizer=rel_l1,rel_var representor.loss.beta=1e-2,1e-1" #"regularizer=huber representor.loss.beta=1e-5" "regularizer=rel_l1_clamp representor.loss.beta=1e-1" ""
  do
