...
from .helpers import Annealer, replicate_shape, weights_init
...
class LearnedSoftmax(nn.Module):
    def __init__(self, temperature=3, is_train_temp=True, is_anneal_temp=True, n_steps=None, min_temperature=0.05, is_gumbel=False, is_hard=False):
        super().__init__()
    ...
    def forward(self, logits):
        ...
        if self.is_gumbel:
            y_hat = GumbelCategorical(temperature, logits=logits, is_hard=self.is_hard).rsample()
        else:
